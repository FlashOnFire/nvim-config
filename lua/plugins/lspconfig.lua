  ...
  },
  {
    ...
    dependencies = {
      ...
      -- Mason must be loaded before its dependents so we need to set it up here.
      {
        ...
        opts = {
          registries = {
            'github:FlashOnFire/mason-registry',
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          --  (Nvim 0.11 added a native mapping for this one)
          ...
          -- Add a keymap to toggle inlay hints in your if the lsp supports them
      ...
      -- Virtual line for current line and virtual text for others fancy algorithm
      -- shamelessly stolen from https://www.reddit.com/r/neovim/comments/1jpbc7s
      ...
      -- Instantly Redraw Diagnostics on mode change
